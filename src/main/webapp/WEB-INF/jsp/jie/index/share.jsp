...
<div class="fly-panel fly-column">
  <div class="layui-container">
    <ul class="layui-clear">
      ...
      <li class="layui-hide-xs layui-this"><a href="${ctx}/jie/index/share">分享<span class="layui-badge-dot"></span></a></li> 
	  ...
	  laypage.render({
	    ...
	    ,curr: ${page} //获取起始页
	  	,jump: function(obj, first){	  	    	  	 
	  	    ...
	  	    if(!first){
	  	      //do something
	  	    	 window.location.href="../index/share?n="+${n}+"&page="+obj.curr+"&&rows="+obj.limit
	  	    }
	  	  }
	  });
	});
