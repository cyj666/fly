...
<div class="fly-panel fly-column">
  <div class="layui-container">
    <ul class="layui-clear">
      <li><a href="/">首页</a></li> 
      <li><a href="${ctx}/jie/index/quiz?n=0">提问</a></li> 
      <li><a href="${ctx}/jie/index/share">分享<span class="layui-badge-dot"></span></a></li> 
      <li class="layui-hide-xs layui-this"><a href="${ctx}/jie/index/discuss?n=0">讨论</a></li> 
      ...
      <dl class="fly-panel fly-list-one">
        <dt class="fly-panel-title">本周热议</dt>
         <c:forEach items="${hotTopic}" var="h" begin="0" end="9">
          <dd>
          <a href="${ctx}/topic/${h.id}">${h.title}</a>
	  ...
	  laypage.render({
	    ...
	    ,curr: ${page} //获取起始页
	  	,jump: function(obj, first){	  	    	  	 
	  	    ...
	  	    if(!first){
	  	      //do something
	  	    	 window.location.href="../index/discuss?n="+${n}+"&page="+obj.curr+"&&rows="+obj.limit
	  	    }
	  	  }
	  });
	});
